...
const Search = ({ expandFilter, setExpandFilter }) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  return (
    <div className="bg-white rounded-[6px] mb-[57px]">
        ...
        >
          ...
          <div className="flex justify-start items-center">
            ...
            <svg width="15" height="12" className="absolute hidden  peer-checked:block outline-none ml-1 pointer-events-none" xmlns="http://www.w3.org/2000/svg">
              <path d="M1 6.57l3.572 3.572L13.714 1" stroke="#FFF" stroke-width="2" fill="none" fill-rule="evenodd" />
            </svg>
