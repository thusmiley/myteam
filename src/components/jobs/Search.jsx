...
const Search = ({ expandFilter, setExpandFilter, titleInput, locationInput, fulltimeInput, setTitleInput, setLocationInput, setFulltimeInput }) => {
      ...
      >
        <div className="flex justify-start items-center bg-white rounded-[6px] p-4 w-full md:p-0 md:pr-6 md:w-[30%] xl:w-[40%]">
          ...
          <input
            ...
            onSubmit={(e) => setTitleInput(e.target.value.toLowerCase())}
          />
        </div>
        ...
        <div className="flex justify-start items-center relative bg-white rounded-[6px] p-4 w-full md:py-0 md:px-6 md:w-[30%]">
          ...
          <input
            ...
            className="min-w-[135px] ml-[7px]"
            onSubmit={(e) => setLocationInput(e.target.value.toLowerCase())}
          />
        </div>
        ...
        <div className="flex justify-start items-center py-4 pr-4 relative w-full md:py-0 md:px-6 md:w-[20%]">
          ...
          <input
            ...
            onSubmit={() => setFulltimeInput(!fulltimeInput)}
          />
        ...
        <button
          type="submit"
          className="cta cta-white text-[16px] absolute bottom-0 right-0 rounded-[5px] md:bg-sacramentoGreen md:border-none md:ml-6 md:relative md:w-[15%] md:px-[14px] xl:w-[10%]"
