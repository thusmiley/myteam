      ...
      <section className="pt-[160px] md:pt-[64px] contact-bg pb-[130px] md:pb-[150px] xl:pt-0 xl:mt-[70px] xl:pb-[120px]">
        <div className="w-container mx-auto text-center md:max-w-[542px] xl:flex xl:text-left xl:max-w-full">
          <div className="xl:w-[50%] xl:mr-[30px]">
            <h1 className="heading1 mb-4 md:mb-6 xl:mb-4 xl:text-[64px]">
              Contact
            </h1>
            <h2 className="heading5 text-lightCoral mb-10 xl:mb-8">
              Ask us about
            </h2>
            <div className="flex items-center justify-start text-left space-x-[23px] md:ml-4 xl:ml-0">
              <img
                ...
                className="h-[72px] w-[72px] object-contain mb-4 md:mb-0"
              />
              <p className="menu font-normal">
          ...
          {/* contact form  */}
          <form
            className="relative group mt-[56px] xl:w-[50%] xl:mt-0"
          ...
          >
            <div className="relative">
              <input
                ...
                className={`${
                  errors.name
                    ? "border-b-lightCoral placeholder:text-lightCoral"
                    : ""
                }`}
                {...register("name", {
                  required: "Required",
            ...
            <button
              type="submit"
              className="cta cta-submit border-none cursor-pointer w-[123px] float-left "
            >
              submit
            </button>
          </form>
